...
RSpec.describe "Menu Panel - ", type: :feature do
  ...
  describe "Opening the Menu button" do
    ...
    describe "as a signed in user" do
      ...
      it "should show a link for 'New Sighting'" do
      ...
      describe "and clicking the New link" do
        before do
  ...
  describe "Opening the Menu button" do
    ...
    describe "when not signed in" do
      before { visit root_path }
      it 'should not be possible' do
        expect(page).not_to have_content('View Research Sites')
    ...
    describe "as a signed in user" do
      ...
      it "should show a link for 'Sites'" do
        expect(page).to have_content('View Research Sites')
        expect(page).to have_link('sites_index')
      end
      it "should show a link for 'New Research Site'" do
        expect(page).not_to have_content('New Research Site')
      ...
      describe "and clicking the View All link" do
        ...
        it "should open up the View All page" do
          expect(page).to have_content('Research Sites')
        end
      end
    ...
    describe "as a superuser" do
      ...
      it "should show a link for 'Research Sites'" do
        expect(page).to have_content('View Research Sites')
        expect(page).to have_link('sites_index')
      end
      it "should show a link for 'New Research Site'" do
        expect(page).to have_content('New Research Site')
    ...
    describe "as an admin" do
      ...
      it "should show a link for 'New Site'" do
        expect(page).to have_content('New Research Site')
        expect(page).to have_link('sites_new')
      end
  ...
  describe "Opening the menu button" do
    ...
    describe "as a signed in user" do
      ...
      it "should not show a link for 'New Species'" do
        expect(page).to_not have_content('New Species')
    ...
    describe "as a superuser" do
      ...
      it "should show a link for 'New Species'" do
